...
```
//  starting v0.2.0 use require ('@nypl/sierra-wrapper') but for versions before that (we encourage you to //  update to latest and change client to reflect the new require format) use require ('sierra-wrapper')
